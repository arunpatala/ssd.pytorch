...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        print("center", center.size(), "dec4", dec4.size())
        
        #enc4 = self.enc4(torch.cat([
        #    center, F.upsample_bilinear(dec4, center.size()[2:])], 1))
        enc4 = self.enc4(torch.cat([center, dec4], 1))
        
        print("enc4", enc4.size(), "dec3", dec3.size())
